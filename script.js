...
function renderPage() {
    ...
    if (currentPage === "home") {
        content.innerHTML = "<h1>Memory in the Age of AI</h1><p>Explore memory with interactive pages and games!</p>";
        ...
        content.innerHTML = "<h2>Boxes</h2><p>Coming soon...</p>";
        ...
        content.innerHTML = "<h2>Games</h2><div id='memory'></div><div id='simon'></div>";
        renderMemory();
        renderSimon();
...
function renderMemory() {
    ...
    turns = 0;
    matches = 0;
    document.getElementById("memory-stats").textContent = "Turns: 0 | Matches: 0";
}
...
function flipCard(card) {
    ...
    document.getElementById("memory-stats").textContent = `Turns: ${turns} | Matches: ${matches}`;
}
